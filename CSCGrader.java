    ...
    public static void main(String[] args) {
        ...
        if (score1 < 0 || score2 < 0 || score3 < 0 || score1 > 100 || score2 > 100 || score3 > 100) { 
            ...
            if(finalScore < 0 || finalScore > 100){
                System.out.println("Final Exam score is out of the range 0..100");
            }else{ //continue
                System.out.println();
    
                // The programming assignments are 55% of the course grade and the final exam is
                // 45%
                ...
                System.out.printf("Program scores entered: %.0f, %.0f, %.0f \n", score1, score2, score3);
                System.out.printf("Final Exam score entered: %.0f\n", finalScore);
